...
const CustomSoftware = ({setSelectedIndex,setValue}) => {
    ...
    return (
        <Grid container className={classes.container} direction="column">
            <Grid style={{marginTop:matchesSm?"0em": "2em"}} item container direction="row" className={classes.rowContainer} justifyContent={matchesMd?"center":undefined}>
                <Hidden mdDown>
             ...
             <Grid item>
                 ...
                 Whether we’re replacing old software or
                  inventing new solutions, Arc Development is here to help your business tackle technology.
                 </Typography>
                 <Typography align={matchesMd ? "center":""} variant="body1" paragraph >
                 Using regular commercial software leaves you with a 
                 lot of stuff you don’t need, without some of the stuff you do need, and ultimately controls the way you work. Without using any software at all you risk falling behind competitors and missing out on huge savings from increased efficiency.
            ...
            <Grid item container className={classes.rowContainer} style={{marginTop:"10em",marginBottom:"12em"}} direction="row" justifyContent="center">
            ...
            <Grid item container direction="column" md alignItems="center" style={{maxWidth:"40em",margin:matchesSm? "5em 0":""}}>
                <Grid item>
                    <Typography variant="h4">
                        Save Money.
                    </Typography>
            ...
            <Grid item className={classes.rowContainer} container  alignItems={matchesMd?"center":""} direction={matchesMd?"column" :"row"} justifyContent="space-between">
              <Grid item container className={classes.itemContainer} 
              direction={matchesSm?"column" :"row"}
              style={{marginBottom:matchesMd?"10em":""}} md>
                  <Grid item container direction="column" md>
                      ...
                      <Grid item>
                          <Typography align={matchesSm?"center":""} variant="body1" paragraph>
                   ...
                   <Grid item md>
                       <Lottie style={{maxHeight:275,maxWidth:275,minHeight:250}}  animationData={documentsAnimation} />
                   </Grid>
              </Grid>
              <Grid item container className={classes.itemContainer} md>
              <Grid item md>
                       <Lottie style={{maxHeight:265,maxWidth:275}}  animationData={scaleAnimation} />
                   </Grid>
                  <Grid item container direction="column" md>
                      <Grid item>
                          <Typography style={{textAlign:!matchesMd? "right":"center"}} variant="h4">
                        Scale
                          </Typography>
                      </Grid>
                      <Grid item>
                          <Typography variant="body1" style={{textAlign:!matchesMd? "right":"center"}} paragraph>
...
Whether you’re a large brand, just getting started, or taking off right now, our application architecture ensures pain-free growth and reliability
            ...
            <Grid className={classes.rowContainer} item container direction="row" style={{margin:"10em 0"}}>
             <Grid item container direction="column" alignItems="center">
                 <Grid item>
                     <img src={roots} alt="roots" height= {matchesSm?"100%" :"450em"} width= {matchesSm?"100%" :"450em"} />
                 </Grid>
            ...
            <Grid item className={classes.rowContainer} container direction="row" justifyContent="space-between" style={{marginBottom:"10em"}}>
              <Grid item container className={classes.itemContainer} style={{marginBottom:matchesMd?"10em":""}} md>
                  <Grid item container direction="column" md>
                      <Grid item>
                          <Typography align={matchesSm?"center":""} variant="h4">
                        Automation
                   ...
                   <Grid item md>
                       <Lottie style={{maxHeight:275,maxWidth:275,minHeight:250}}  animationData={automationAnimation} />
                   </Grid>
              </Grid>
              <Grid item container direction={matchesMd?"column-reverse":undefined} className={classes.itemContainer} md>
              <Grid item md  justifyContent={matchesMd?"center":undefined}>
                       <Lottie style={{maxHeight:225,maxWidth:205,marginLeft:matchesMd?"3em":""}}  animationData={userAnimation} />
                   </Grid>
                  <Grid item container direction="column" md>
                      <Grid item>
                          <Typography style={{textAlign: !matchesMd ?"right":"center"}} variant="h4">
