  ...
  return(
      <Grid container direction="column">
         ...
         <Hidden mdDown>
              ...
              <IconButton onClick={()=>setSelectedIndex(1)} component={Link} to="/customsoftware" >
             ...
             <Grid item className={classes.arrowContainer}>
                <IconButton onClick={()=>setSelectedIndex(3)} component={Link} to="/websites" >
                  <img alt="Forward button" src={fwArrow} /> 
                 </IconButton>
             </Grid>
             </Hidden>
            </Grid>
            <Grid item style={{margin:"10em 0"}} container direction={matchesMd? "column":"row"} alignItems={matchesMd?"center":""} className={classes.rowContainer}>
            <Grid item container  direction="column" md>
                <Grid item>
                    <Typography align={matchesMd?"center":""}  variant="h4" gutterBottom>Integration</Typography>
                </Grid>
                <Grid item>
                    <Typography align={matchesMd?"center":""} variant="body1" paragraph>
            ...
            <Grid item md>
                <Lottie style={{maxWidth:"20em"}} autoplay loop animationData={mobileAnimation} />
            </Grid>
            <Grid item container direction="column" md>
                <Grid item>
                    <Typography align={matchesMd?"center":"right"} variant="h4" gutterBottom>Simultaneous Platform Support</Typography>
                </Grid>
                <Grid item>
            ...
            <Grid container style={{marginBottom:"15em"}} direction={matchesMd? "column":"row"} className={classes.rowContainer} item>
             ...
             <Grid style={{margin:matchesMd && "5em 0"}} direction="column" item container alignItems="center" md>
              <Grid item >
                  <Typography gutterBottom variant="h4">
                Extend Access
                  </Typography>
              ...
              <Grid item>
               <img src={access} style={{maxWidth: matchesMd? "20em":"26em"}} alt="access"/>
              </Grid>
             </Grid>
            ...
            <Grid item>
                <CallToAction setValue={setValue} setSelectedIndex={setSelectedIndex}/> </Grid>
      </Grid>
  )
  }